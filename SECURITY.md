...
Thank you for taking the time to contribute to the security of [misha-ssh/cli](https://github.com/misha-ssh/cli). This document outlines the steps to report vulnerabilities and our approach to addressing security issues. Please report it to us as described below.
